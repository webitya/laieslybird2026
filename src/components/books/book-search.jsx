...
export default function BookSearch({ books, onSearch, searchQuery, onSuggestionClick }) {
    ...
    ? books
        .filter(
          (b) =>
            ...
            (b.tags && b.tags.some((tag) => tag.toLowerCase().includes(query.toLowerCase()))),
        )
        .slice(0, 8)
    : []
  ...
  return (
    <div className="relative w-full">
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search books by title, topic, course..."
          value={query}
